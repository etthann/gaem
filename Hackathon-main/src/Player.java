...
public class Player extends Characters {
    ...
    public void draw(Graphics2D g2) {
        ...
        //draw stamina bar
        g2.drawImage(staminaBar,screenX-9*gp.tileSize,screenY-6*gp.tileSize, 900*stamina/maxStam,5,null);
    }

    // Updates the characters position
    public void update() {
        if(closetCD>0)closetCD--;
        ...
        if(hiding == false){
            ...
            if (keyH.upPressed || keyH.downPressed || keyH.leftPressed || keyH.rightPressed) {
                ...
                if (teleportOn) {
                    System.out.println("teleporting 11111");
                    ...
                    } else if ((worldX + solidArea.x) / gp.tileSize == 48 && (worldY + solidArea.y) / gp.tileSize == 9) {
                        if (gp.tileM.currentMap.equals("downStairs")) {
                            if (gp.tileM.currentMap.equals("downStairs")) {
                                gp.tileM.currentMap = "upStairs";
                                gp.tileM.loadMapUpStairs();
                    ...
                    } else if ((worldX + solidArea.x) / gp.tileSize == 34 && (worldY + solidArea.y) / gp.tileSize == 9) {
                        if (gp.tileM.currentMap.equals("upStairs")) {
                            gp.tileM.currentMap = "downStairs";
                            gp.tileM.loadMapDownStairs();
                    ...
                    // if ((worldX + solidArea.x) / gp.tileSize == 5 && (worldY + solidArea.y) / gp.tileSize == 5) {
                    //     if (gp.tileM.currentMap.equals("upStairs")) {
                    //         gp.tileM.currentMap = "parentsRoom";
                    //         gp.tileM.loadMapParentsRoom();
                    //         worldX = 5 * gp.tileSize;
