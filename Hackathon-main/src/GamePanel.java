...
public class GamePanel extends JPanel implements Runnable {
    ...
    public void run() {
        ...
        while (gameThread != null && tutorial == true) {// code in this loop will always run repeat sorta like game ticks
        ...
        while (gameThread != null && tutorial == false) {// code in this loop will always run repeat sorta like game ticks
            currentTime = System.nanoTime();
            delta += (currentTime - lastTime) / drawInterval;
            timer += (currentTime - lastTime);
            lastTime = currentTime;
