        ...
        if(spawns>0){
            if (gp.tileM.currentMap.equals("downStairs")) {
                for(int i = 0;i<giftsDown.size() ;i++){
                    ...
                    g2.drawImage(tile[0].image, x- gp.player.worldX + gp.player.screenX,y - gp.player.worldY + gp.player.screenY,  gp.tileSize, gp.tileSize, null);
                }
            }
        ...
        if(spawns>0){
            if (gp.tileM.currentMap.equals("downStairs")) {
                ...
                for(int i = 0;i<giftsKids.size() ;i++){
                    ...
                    // System.out.print(("Player " + (entity.worldX+24)/gp.tileSize+" "+(entity.worldY+72)/48));
